pipeline {
    ...
    environment {
        ...
        IMAGE_TAG = 'latest'
        SERVICE_NAME = 'llmops-medical-service-2'
    }
        ...
        stage('Clone GitHub Repo') {
            steps {
                script {
                    ...
                    checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-token', url: 'https://github.com/teddyondieki/medical-rag.git']])
                }
            }
        }
